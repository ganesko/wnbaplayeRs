...
- `player_shot_chart()`, which visualizes where players shoot from on the court in a selected WNBA season.
...
The data included in this package is sourced from the WNBA's official website.

## Examples

Using `get_wnba_player_stats function`, users can easily get a snapshot of information about a selected player, and can get quickly linked to the player's stat webpage. 
